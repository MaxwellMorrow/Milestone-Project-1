...
window.addEventListener("click",(e)=>{
    ...
    if(e.target === downBtn && checkMoveDown === false && gameStarted && gameRestarted){
    ...
    if(e.target === upBtn && checkMoveUp === false && gameStarted && gameRestarted){
    ...
    if(e.target === rightBtn && checkMoveRight === false && gameStarted && gameRestarted){
    ...
    if(e.target === leftBtn && checkMoveLeft === false && gameStarted && gameRestarted){
