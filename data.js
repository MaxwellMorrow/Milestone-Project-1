...
let wallsData = [
    ...
    ,{x:16,y:0},{x:17,y:0},{x:18,y:0},{x:6,y:11},{x:10,y:11},{x:11,y:11}
]
let toggleWallData = [{x:10,y:11},{x:11,y:11}]

let treasureData = [
    {x:9,y:13},{x:10,y:13},{x:9,y:14},{x:10,y:14}
]
let wallToggleData = [{x:19,y:16},{x:19,y:17},{x:20,y:17},{x:20,y:16}]
